...
public class Game {
  ...
  public void findGameVersion() {
    ...
    try {
      output_log = Files.readAllLines(Paths.get(
          System.getenv("APPDATA").substring(0, System.getenv("APPDATA").length() - 7)
              + "LocalLow\\Boundless Dynamics, LLC\\VTOL VR\\output_log.txt"));
